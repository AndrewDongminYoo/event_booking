...
- Personalized Event List: Display a personalized list of events each user has booked.
...
- Accent color: Deep pink (#FF1493), a similar color as the primary but in much higher saturation and slightly lower brightness, to highlight key interactive elements such as buttons and links.
- Body and headline font: 'Pretendard', a sans-serif, for a geometric, contemporary, and fashionable look.
- Use custom icons related to K-pop culture and events.
- Use a modern, grid-based layout for event listings.
- Subtle animations for event transitions and user interactions.
